          ...
          <div className="bg-[#1A1A1A] border border-[#D4AF37]/30 rounded-2xl p-6 max-w-sm w-full" onClick={e => e.stopPropagation()}>
            ...
            <div className="space-y-3">
              {connectors.map((connector) => {
                ...
                let subtitle = 'Web3 Wallet';
                
                if (isMetaMask) {
                  icon = '🦊';
                  displayName = 'MetaMask';
                  subtitle = typeof window !== 'undefined' && window.ethereum ? 'Connect now' : 'Browser extension';
                } else if (isCoinbase) {
                  icon = '🔵';
                  displayName = 'Coinbase Wallet';
                  subtitle = 'Smart Wallet or Extension';
                }
              ...
              {/* Mobile MetaMask deep link - show only on mobile without ethereum */}
              {typeof window !== 'undefined' && !window.ethereum && /Android|iPhone|iPad|iPod/i.test(navigator.userAgent) && (
                <a
                  href={`https://metamask.app.link/dapp/${typeof window !== 'undefined' ? window.location.host : 'basegold-miniapp.vercel.app'}`}
                ...
                >
                  <span className="text-3xl">📱</span>
                  <div className="text-left flex-1">
                    <div className="text-white font-medium">Open in MetaMask</div>
                    <div className="text-xs text-orange-400">Open this app in MetaMask browser</div>
                  </div>
